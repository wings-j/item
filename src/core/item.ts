...
class Item<T = any> implements ItemType<T> {
   ...
   */
  static _assignExtra(item: Item, extra: any): void {
    for (let i in extra) {
   ...
   * @return Target
   */
  find(identify: (item: typeof this) => boolean): typeof this | undefined {
   ...
   * @return Item Array
   */
  trace(target: typeof this): (typeof this)[] | undefined {
    let temp: (typeof this)[] = [];
